...
CodeBehind="u_cri_acc_tribalance_mju.aspx.cs" Inherits="Saving.CriteriaIReport.u_cri_account.u_cri_acc_tribalance_mju.u_cri_acc_tribalance_mju" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <center>
        <asp:Label ID="Label1" runat="server" Font-Bold="true" Font-Size="Medium">	รายงานงบทดลอง</asp:Label><br />
            ...
            <td colspan="3">
                <div>
                    <asp:DropDownList ID="dd_form"  Width="300" runat="server">
                        ...
                        <asp:ListItem Value="02"> กระดาษทำการงบทดลอง</asp:ListItem>
