...
namespace Saving.CriteriaIReport.u_cri_coopid_ryears
{
    public partial class u_cri_coopid_ryears : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            int as_syear = (Convert.ToInt32(dsMain.DATA[0].as_syear));
            int as_eyear = (Convert.ToInt32(dsMain.DATA[0].as_eyear)) ;
