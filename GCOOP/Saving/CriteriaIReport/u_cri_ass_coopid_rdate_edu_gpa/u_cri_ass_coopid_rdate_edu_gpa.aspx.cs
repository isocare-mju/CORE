...
namespace Saving.CriteriaIReport.u_cri_ass_coopid_rdate_edu_gpa
{
    public partial class u_cri_ass_coopid_rdate_edu_gpa : PageWebReport, WebReport
    {
        protected String app;
        protected String gid;
        protected String rid;
        [JsPostBack]
        public string postgpamin { get; set; }
        [JsPostBack]
        public string postgpamax { get; set; }
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsMain.DATA[0].gpa_min = "0.00";
                dsMain.DATA[0].gpa_max = "4.00";
            }
        }
        ...
        public void RunReport()
        {
            ...
            string gpa_min = dsMain.DATA[0].gpa_min;
            string gpa_max = dsMain.DATA[0].gpa_max;
            try
            {
                ...
                arg.Add("gpa_min", iReportArgumentType.String, gpa_min);
                arg.Add("gpa_max", iReportArgumentType.String, gpa_max);
