<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_rloantype_period.DsMain" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="month" runat="server">
                        <asp:ListItem Value="0" Text="เลือกเดือน"></asp:ListItem>
