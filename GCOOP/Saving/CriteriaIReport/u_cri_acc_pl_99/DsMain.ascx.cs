...
namespace Saving.CriteriaIReport.u_cri_acc_pl_99
{
    public partial class DsMain : DataSourceFormView
    {
        ...
        {
            String sql = @"select moneysheet_code, moneysheet_code||'-'|| moneysheet_name as moneysheet_name from accsheetmoneyhead where moneysheet_code = '99' order by moneysheet_code";
            sql = WebUtil.SQLFormat(sql);
            DataTable dt = WebUtil.Query(sql);
