...
namespace Saving.CriteriaIReport.u_cri_coopid_rrevcperiod_rloantype
{
    public partial class u_cri_coopid_rrevcperiod_rloantype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            int an_period = Convert.ToInt32((dsMain.DATA[0].year-543) + dsMain.DATA[0].month.ToString("00"));
            int an_eperiod = Convert.ToInt32((dsMain.DATA[0].eyear - 543) + dsMain.DATA[0].emonth.ToString("00"));
            string loantypes = dsMain.DATA[0].start_loantype;
            string loantypee = dsMain.DATA[0].end_loantype;
            ...
            try
            {
                ...
                arg.Add("as_eperiod", iReportArgumentType.String, Convert.ToString(an_eperiod));
                arg.Add("as_startlntype", iReportArgumentType.String, loantypes);
                arg.Add("as_endlntype", iReportArgumentType.String, loantypee);
