<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_rrevcperiod_rloantype.DsMain" %>
        ...
        <table class="iReportDataSourceFormView">
            ...
            <tr>
                ...
                <td width="20%">
                    ...
                    -
                    <asp:TextBox ID="eyear" runat="server" Style="text-align: center"></asp:TextBox>
                </td>
                <td width="20%">
                    <div>
                        <span>เดือน:</span></div>
