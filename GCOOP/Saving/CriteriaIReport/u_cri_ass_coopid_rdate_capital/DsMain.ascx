<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_ass_coopid_rdate_capital.DsMain" %>
        ...
        <table class="iReportDataSourceFormView">
            ...
            <tr>
                ...
                <td width="35%" colspan="2">
                    <asp:TextBox ID="pay_num" runat="server" Style="width:95%"></asp:TextBox>
                </td>
            </tr> 
        </table>
    </EditItemTemplate>
