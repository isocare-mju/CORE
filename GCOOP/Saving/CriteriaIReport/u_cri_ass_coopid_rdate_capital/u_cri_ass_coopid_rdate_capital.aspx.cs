...
namespace Saving.CriteriaIReport.u_cri_ass_coopid_rdate_capital
{
    public partial class u_cri_ass_coopid_rdate_capital : PageWebReport, WebReport
    {
        ...
        {
            int pay_num = Convert.ToInt32(dsMain.DATA[0].pay_num);
            ...
            try
            {
                ...
                arg.Add("pay_num", iReportArgumentType.Integer, pay_num);
