...
{
    public partial class u_cri_ass_coopid_rdate_stu_class : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsMain.DdStartEdulevel();
                dsMain.DdEndEdulevel();
                dsMain.DefaultStartEdulevel();
                dsMain.DefaultEndEdulevel();
            }
        }
        ...
        public void RunReport()
        {
            ...
            string edulevel_start = dsMain.DATA[0].edulevel_start;
            string edulevel_end = dsMain.DATA[0].edulevel_end;
            try
            {
                ...
                arg.Add("edulevel_start", iReportArgumentType.String, edulevel_start);
                arg.Add("edulevel_end", iReportArgumentType.String, edulevel_end);
