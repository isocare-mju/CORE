<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_acc_report_pl_99.aspx.cs" Inherits="Saving.Criteria.u_cri_acc_report_pl_99" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_acc_report_pl_99"
    ...
    <asp:HiddenField ID="HdTotalShow" runat="server" value="False"/>
    <%=outputProcess%>
</asp:Content>
