<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_sl_collateral_master.aspx.cs" Inherits="Saving.Applications.shrlon.ws_sl_collateral_master_ctrl.ws_sl_collateral_master" %>
...
<%@ Register Src="DsCar.ascx" TagName="DsCar" TagPrefix="uc9" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnDsMainClicked(s, r, c, v) {
            if (c == "b_memsearch") {
                Gcoop.OpenIFrame("630", "720", "w_dlg_member_search.aspx", "")
            }
        ...
        function OnDsCarClicked(s, r, c, v) { }

        function OnDsCarItemChanged(s, r, c, v) { }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <div style="text-align: right">
            <span class="NewRowLink" onclick="PostInsertRowBdingdet()" style="font-size: small;">
                เพิ่มแถว </span>
        </div>
    ...
    <asp:Panel ID="Panel6" runat="server">
        <uc9:DsCar ID="dsCar" runat="server" />
    </asp:Panel>
    <br />
    <hr />
    <table width="100%">
        <tr>
            <td valign="top" align="left">
                <asp:Panel ID="Panel5" runat="server">
                    <br />
                    <div style="text-align: right">
                        <span class="NewRowLink" onclick="PostInsertRowCollprop()" style="font-size: small;
                            margin: 0px 25px 0px 0px">เพิ่มผู้มีกรรมสิทธิ์ </span>
                    </div>
