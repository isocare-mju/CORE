    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td>
                    <div>
                        <asp:TextBox ID="member_no" runat="server" Style="text-align: center" Width="80%"></asp:TextBox>
                        <asp:Button ID="bt_search" runat="server" Text="..." Width="15%" />
                    </div>
                </td>
                <td>
                    <div>
        ...
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td>
                    <div>
                    <asp:TextBox ID="old_periodpercent" runat="server" Style="text-align: center;background-color: ButtonFace;" ToolTip="#,##0.00" ReadOnly="true" Width="20%" ></asp:TextBox>
                        <asp:TextBox ID="old_periodvalue" runat="server" Style="text-align: right; background-color: ButtonFace;"
                            ReadOnly="true" ToolTip="#,##0.00" Width="75%"></asp:TextBox>
                    </div>
                </td>
                <td>
                    <div>
                ...
                <td>
                    <div>
                    <asp:TextBox ID="new_periodpercent" runat="server" Style="text-align: center" ToolTip="#,##0.00" Width="20%"></asp:TextBox>
                        <asp:TextBox ID="new_periodvalue" runat="server" Style="text-align: right" ToolTip="#,##0.00" Width="75%"></asp:TextBox>
                    </div>
                </td>
            </tr>
            <tr>
