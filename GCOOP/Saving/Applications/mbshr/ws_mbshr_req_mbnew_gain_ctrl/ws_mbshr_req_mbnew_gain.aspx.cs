...
namespace Saving.Applications.mbshr.ws_mbshr_req_mbnew_gain_ctrl
{
    public partial class ws_mbshr_req_mbnew_gain : PageWebSheet, WebSheet
    {
        ...
        public String PostMembgroupCodeFromDlg { get; set; }
         [JsPostBack]
        public String Postincomeetc { get; set; }
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == Postincomeetc)
            {
                if (dsMain.DATA[0].SALARY_AMOUNT == 0)
                {
                    dsMain.DATA[0].PERIODSHARE_VALUE = 0;
                    dsMain.DATA[0].PERIODBASE_VALUE = 0;
                }
                else {
                    String memcoop_id = state.SsCoopControl;
        ...
        private Decimal CalPayShareMonth(String memcoop_id, String sharetype_code, Decimal member_type, Decimal salary_amount)
        {
            ...
            // by Bear
            return Math.Ceiling(share_mth/100) *100;
        }
