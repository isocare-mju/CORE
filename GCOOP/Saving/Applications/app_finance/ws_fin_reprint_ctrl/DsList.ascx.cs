...
namespace Saving.Applications.app_finance.ws_fin_reprint_ctrl
{
    public partial class DsList : DataSourceRepeater
    {
        ...
        public void Retrieve(string member_no, string entry_id, decimal pay_recv_status, string slip_no_s, string slip_no_e, DateTime slip_date_s, DateTime slip_date_e, decimal member_flag)
        {
            string sqlext = "";
            if (member_no != "")
            {
            ...
            sqlext += " and member_flag  = " + member_flag ;
