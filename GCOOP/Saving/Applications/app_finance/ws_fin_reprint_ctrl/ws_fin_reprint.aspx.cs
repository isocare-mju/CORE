    ...
    public partial class ws_fin_reprint : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            if (!IsPostBack)
            {
                ...
                dsList.Retrieve(dsMain.DATA[0].MEMBER_NO, dsMain.DATA[0].ENTRY_ID, dsMain.DATA[0].PAY_RECV_STATUS, "", "", state.SsWorkDate, state.SsWorkDate,1);
            }
        }
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostRetrieve)
            {
                try
                {
                    ...
                    string slip_no_s = "";
                    string slip_no_e = "";
                    decimal payrecv_status = 0, member_flag = 1;
                    ...
                    member_flag = dsMain.DATA[0].member_flag;
                    dsList.Retrieve(member_no, entry_id, payrecv_status, slip_no_s, slip_no_e, slip_date_s, slip_date_e, member_flag);
                }
                catch { }
            }
