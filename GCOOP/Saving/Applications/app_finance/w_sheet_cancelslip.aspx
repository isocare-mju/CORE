...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DwHeadChanged(sender, rowNumber, objectName, nValue) {
            if (objectName == "ai_memberflag") {
                if (nValue == "3" || nValue == "4" || nValue == "8") {
                    objDwHead.SetItem(rowNumber, "as_memberno", '');
                }
            }
        }
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="DwHead" runat="server" DataWindowObject="d_cancelslip_head"
                    ...
                    ClientEventButtonClicked="DwHeadButtonClicked" ClientEventClicked="DwHeadClick" ClientEventItemChanged="DwHeadChanged">
