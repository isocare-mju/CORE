        ...
        <table class="DataSourceFormView">
             ...
             <td>
              ...
              <td>
                ...
                <td colspan="3" style="width:100%">
                    <asp:TextBox ID="mbaddr" runat="server" BackColor=" #FFFF99" ReadOnly="True" Width="99%"></asp:TextBox>
                </td>
            </tr>
            <tr>
             <td>
              ...
              <td>
                    <asp:TextBox ID="retire_date" runat="server" Style="width: 45%; text-align: center;"
                        BackColor=" #FFFF99" ReadOnly="True"></asp:TextBox>
                    <asp:TextBox ID="cp_retire_age" runat="server" Style="width: 50%; text-align: center;"
                        BackColor=" #FFFF99" ReadOnly="True"></asp:TextBox>
                </td>
                 <td>
                    <div>
                 ...
                 <td>
                     <asp:TextBox ID="salary_amount" runat="server" Style="text-align: right" ToolTip="#,##0.00" BackColor=" #FFFF99" ReadOnly="True"></asp:TextBox>
                </td>
                 <td>
                    <div>
                        <span>สถานภาพ:</span>
            ...
            <tr>
                ...
                <td>
                 ...
                 <td>
                    <asp:TextBox ID="reqstatus_desc" runat="server" Style="text-align: center;" BackColor=" #FFFF99" ReadOnly="True" Width="97%"></asp:TextBox>
                </td>
                <td>
                 <div>
                        <span>รูปภาพ:</span>
