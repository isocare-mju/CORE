<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMbShr.ascx.cs" Inherits="Saving.Applications.assist.dlg.wd_fom_upload_image_ctrl.DsMbShr" %>
