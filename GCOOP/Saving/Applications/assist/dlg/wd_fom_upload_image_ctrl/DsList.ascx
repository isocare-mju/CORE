<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.assist.dlg.wd_fom_upload_image_ctrl.DsList" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="update_date" runat="server" Style="text-align: center;" ReadOnly="true"></asp:TextBox>
                </td>
                <td>
