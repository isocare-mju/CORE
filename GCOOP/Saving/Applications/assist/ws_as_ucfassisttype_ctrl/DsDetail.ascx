...
<%--                    <asp:CheckBox ID="membdate_flag" runat="server" />
                    เป็นสมาชิกก่อนวันที่--%>
                     ...
                     <asp:DropDownList ID="membdate_flag" runat="server">
                        <asp:ListItem Value="0">ไม่ตรวจวันที่</asp:ListItem>
                        <asp:ListItem Value="1">เป็นสมาชิกก่อนวันที่ </asp:ListItem>
                        <asp:ListItem Value="2">เป็นสมาชิกหลังวันที่ </asp:ListItem>
                        <asp:ListItem Value="3">ขอสวัสดิการได้ถึงวันที่ </asp:ListItem>
                    </asp:DropDownList>
                </td>
            ...
            <tr>
              <td>
                ...
                <td>
                    <div>
                        <span>เช็คอายุบุตร(ปี):</span>
                    </div>
                </td>
                <td >
                    <asp:TextBox ID="child_age" runat="server" Style="text-align: center;"></asp:TextBox>
                </td>
            </tr>
        </table>
        <br />
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="limitcut_type" runat="server">
                        ...
                        <asp:ListItem Value="1">หักยอดที่รับไปแล้ว</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td colspan="3">
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="stm_flag" runat="server">
                        ...
                        <asp:ListItem Value="3">จ่ายต่อเนื่องทุกเดือน(ทำใบคำขอครั้งแรกเอง)</asp:ListItem>
                        <asp:ListItem Value="4">จ่ายต่อเนื่องทุกปี(ทำใบคำขอครั้งแรกเอง)</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
                    <div>
